...
export default function Home() {
  ...
  return (
    <>
      <Helmet>
        <title>Felix Electric | Licensed Electrician Tucson AZ | Call (520) 304-3644</title>
        <meta name="description" content="Felix Electric — licensed electrician in Tucson, AZ. Residential & commercial electrical service, panel upgrades, EV chargers, emergency repairs. Call (520) 304-3644 for same-day service." />
