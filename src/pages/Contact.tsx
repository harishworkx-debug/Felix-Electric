...
export default function Contact() {
  ...
  return (
    <>
      <Helmet>
        <title>Contact Felix Electric | Electrician Tucson AZ | (520) 304-3644</title>
        <meta name="description" content="Contact Felix Electric for licensed electrical service in Tucson, AZ. Call (520) 304-3644 or fill out our form for a free quote. Same-day service available." />
